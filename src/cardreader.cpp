...
//TODO Secuencia de arranque 
void CardReader::openAndPrintFile(const char *name) {

  int  valor=setTemp(); // Por defecto 190, si el usuario lo modifica  cambiara
  //SERIAL_ECHO_START();
  int valorArray[]={0,0,0};
  //SERIAL_ECHOPAIR(" temperatura set:",valor);
  //SERIAL_ECHOPAIR(" Valor init Array=",valorArray);
  ...
  //SERIAL_ECHOPAIR(" temperatura set:",valorArray);
  //SERIAL_ECHOPAIR(" temperatura set:",valor);

  char *constComand ="M109 S235";
  int numTemp = 0;
  for (int i=6;i<=8;i++){
    switch(valorArray[numTemp]){
      case 1:
        constComand[i]='1'; 
        break; 
      case 2:
  ...
  //SERIAL_ECHOPAIR(" temperatura set:",constComand);
  enqueue_and_echo_command(constComand);

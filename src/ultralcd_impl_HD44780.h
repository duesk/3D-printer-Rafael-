...
// TODO  INICIO de pantalla 
  ...
  static void logo_lines() {
    ...
    lcd.setCursor(0, 0); lcd_printPGM(PSTR(" - - - - - - - - -  "));  
    //lcd.setCursor(0, 1); lcd_printPGM(PSTR("| Colibri  Home v3 |"));
    lcd.setCursor(0, 2); lcd_printPGM(PSTR(" - - - - - - - - -  "));
    //lcd.setCursor(0, 3); lcd_printPGM(PSTR("  www.colibri3d.com "));

  }

  static void logo_lines2() {
    //int16_t indent = (LCD_WIDTH - 8 - lcd_strlen_P(extra)) / 2;
    lcd.setCursor(0, 0); lcd_printPGM(PSTR("  - - - - - - - - - "));  
    //lcd.setCursor(0, 1); lcd_printPGM(PSTR("| Colibri  Home v3 |"));
    lcd.setCursor(0, 2); lcd_printPGM(PSTR("  - - - - - - - - - "));
